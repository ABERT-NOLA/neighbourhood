...
urlpatterns = [
    ...
    path('', views.member_index, name='welcome-index'),
    path('post/<int:id>/like', views.like_post, name= 'like-post'),
    path('post/<int:id>/comment', views.leave_comment, name='comment-post')
]